...
const contractAddress = '0x8b6a2d7b98ca08d5052d75612cd7573877d5c411'; 
...
const NoTileDialog = ({ isOpen, onClose, heading, description, img, marketId,end_date,result_date,selectedCategory,displayTotalBets }) => {
  ...
  const tileImage = categoryImages[selectedCategory] || election;
  return (
    <>
      {isOpen && (
        <div className="tile-dialog-overlay">
          <div className="no-tile-dialog" ref={noDialogRef}>
            <button className='close-button' onClick={onClose}><IoMdCloseCircle /></button>
