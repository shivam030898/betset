...
const contractAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bool", name: "betOnYes", type: "bool" },
      {
        indexed: false,
        internalType: "uint256",
        name: "amount",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_resultDate", type: "uint256" },
      { internalType: "uint256", name: "_commission", type: "uint256" },
      { internalType: "uint256", name: "_withdrawCommission", type: "uint256" },
    ],
    name: "createMarket",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "resultDate", type: "uint256" },
      ...
      { internalType: "uint256", name: "withdrawCommission", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [
      { internalType: "uint256", name: "marketId", type: "uint256" },
      { internalType: "bool", name: "betOnYes", type: "bool" },
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "marketId", type: "uint256" },
      { internalType: "uint256", name: "newEndDate", type: "uint256" },
    ],
    name: "updateEndDate",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "marketId", type: "uint256" },
      { internalType: "uint256", name: "newResultDate", type: "uint256" },
    ],
    name: "updateResultDate",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
const YesTileDialog = ({
  ...
  const handleBetYesClick = async () => {
    ...
    try {
      const stableTokenInstance = new ethers.Contract(
        stableTokenAddress,
        stableTokenAbi,
        ethersProvider.getSigner()
      );

      const allowance = await stableTokenInstance.allowance(
        walletAddress,
        contractAddress
      );
      ...
      if (allowanceBN.gte(amountBN)) {
        const transaction = await contractInstance.placeBet(
          marketId,
          true,
          amount
        );
        ...
        const approveTx = await stableTokenInstance.approve(
          contractAddress,
          amount
        );
    ...
    <>
      {isOpen && (
        <div className="tile-dialog-overlay">
          <div className="yes-tile-dialog" ref={yesDialogRef}>
            ...
            <div className="tile-dialog-content">
              ...
              <div className="button-container">
                <button className="yes-bet-button" onClick={handleBetYesClick}>
                  Bet Yes
                </button>
              </div>
              <div className="misc">
